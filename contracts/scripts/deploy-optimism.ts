/**
 * Deploy WHSMC + BridgeMinter on Optimism
 * =======================================
 *
 * REQUIRED env vars:
 *   DEPLOYER_PRIVATE_KEY       EOA with ETH for gas
 ...
 *   OPTIMISTIC_ETHERSCAN_API_KEY  For automatic verification
 *
 * Usage:
 *   npx hardhat run scripts/deploy-optimism.ts --network optimism
 *
 * Output: deployments/optimism.json
 */
...
async function main() {
  ...
  console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
  console.log(`▶ Network : ${network.name} (Optimism)`);
  ...
  const manifest = {
    ...
    nextSteps: [
      ...
      `Verify on Etherscan (Optimism): npx hardhat verify --network optimism ${whsmcAddr} ${admin}`,
