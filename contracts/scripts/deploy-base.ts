/**
 * Deploy WHSMC + BridgeMinter on Base
 * ===================================
 *
 * REQUIRED env vars:
 ...
 *   BASESCAN_API_KEY           For automatic verification
 *
 * Usage:
...
async function main() {
  ...
  console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
  console.log(`▶ Network : ${network.name} (Base)`);
  ...
  const manifest = {
    ...
    nextSteps: [
      ...
      `Verify on Basescan: npx hardhat verify --network base ${whsmcAddr} ${admin}`,
